...
namespace Sample01.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            ViewBag.Category_Ref = new SelectList(db.ProductCategory, "Id", "CategoryName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,ProductCode,ProductName,ProductDescription,UnitPrice,Category_Ref")] Product product)
        {
            ...
            ViewBag.Category_Ref = new SelectList(db.ProductCategory, "Id", "CategoryName", product.Category_Ref);
            return View(product);
        }
